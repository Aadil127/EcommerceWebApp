    ...
    <?php
        if($ProductQuantityInStorage <= 0){
            ...
            <div class="cartOptions">
                <div class="cartRemoveOne focusable" tabindex="0" data-id="<?= htmlspecialchars($ProductID)?>">-</div>
                <div class="cartQuantityNumber"><?= htmlspecialchars($productQuantity) ?></div>
                <div class="cartAddOne focusable" tabindex="0" data-id="<?= htmlspecialchars($ProductID)?>">+</div>
            </div>
            <div class="removeFromCart focusable" tabindex="0" data-id="<?= htmlspecialchars($ProductID)?>">
